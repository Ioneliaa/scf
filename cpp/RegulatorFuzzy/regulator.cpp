...
{
	functiiEroare[0] = trapez(-1, -0.8, -0.4, -0.2, e);		//NB
	...
	functiiEroare[4] = trapez(0.15, 0.25, 0.8, 1, e);			//PB
...
{
	functiiDerivataEroare[0] = trapez(-1, -1, -0.8, 0, de);		//NE
	functiiDerivataEroare[1] = triunghi(-0.8, 0, 0.2, de);		//ZE
	functiiDerivataEroare[2] = trapez(0, 0.2, 0.8, 1, de);		//PO
