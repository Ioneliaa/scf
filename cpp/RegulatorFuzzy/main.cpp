...
int main()
{
	...
	c1 = CalculCentruTrapez(-1, -0.8, -0.2, -0.1, iesire[0]);
	c2 = CalculCentruTrapez(-0.2, -0.15, -0.1, -0, iesire[1]);
	c3 = CalculCentruTriunghi(-0.1, 0, 0.2, iesire[2]);
	c4 = CalculCentruTrapez(0, 0.2, 0.6, 0.8, iesire[3]);
	c5 = CalculCentruTrapez(0.6, 0.8, 1, 1, iesire[4]);
